    ...
    >
      <View className="w-[104px] rounded-md h-[104px] overflow-hidden ">
        <Image
          ...
          resizeMode="cover"
          source={{uri:dataArray[id]?.image?dataArray[id]?.image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzCTMhnLo43ZCkuSoHwfvO8sj3nLMJLU9_EA&s"}}
        />
      </View>

      <View className=" mt-2">
        <Text className=" text-gray-400  text-xs " >{languages?"القرآن الكريم من":"Whole Quran by"}</Text>
